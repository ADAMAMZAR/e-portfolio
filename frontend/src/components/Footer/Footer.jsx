  ...
  return (
    <footer className="portfolio-footer">
      <div className="contact-section">
        ...
        <p className="contact-subtitle">Get in touch for collaborations, opportunities, or just to say hi.</p>
        
        <div className="contact-action-grid">
          {profile?.socials?.linkedin?.enabled && profile?.socials?.linkedin?.url && (
            <a href={profile.socials.linkedin.url} target="_blank" rel="noopener noreferrer" className="contact-btn">
          ...
          {profile?.socials?.whatsapp?.enabled && profile?.socials?.whatsapp?.url && (
            <a href={profile.socials.whatsapp.url} target="_blank" rel="noopener noreferrer" className="contact-btn">
              <svg viewBox="0 0 24 24" fill="currentColor">
          ...
          {profile?.socials?.gmail?.enabled && profile?.socials?.gmail?.url && (
            <a href={`mailto:${profile.socials.gmail.url}`} className="contact-btn">
              <svg viewBox="0 0 24 24" fill="currentColor">
          ...
          {profile?.resume_url && (
            <a href="/api/resume" target="_blank" rel="noopener noreferrer" className="contact-btn">
              <svg viewBox="0 0 24 24" fill="currentColor">
